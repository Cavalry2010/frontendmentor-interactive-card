...
This challenge was really good to continue practicing form validation using JavaScript and also using it to create an interactive card and update its values in real time.
